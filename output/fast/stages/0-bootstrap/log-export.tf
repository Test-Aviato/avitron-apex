...
module "log-export-project" {
  ...
  services = [
    ...
    "logging.googleapis.com", #Enabling logging service
    "monitoring.googleapis.com", #Enabling monitoring service for Log Metric Filters
    "cloudasset.googleapis.com", #Enabling Cloud Asset Inventory
    "containeranalysis.googleapis.com", #Enabling AR Container Analysis
    "containerscanning.googleapis.com"  #Enabling GCR Container Scanning
  ]
  iam = {
